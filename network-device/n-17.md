...
참고 받는다는 신호 절차를 거치지 않고, 보내는 쪽에서 일방적으로 데이터를 전달하는 통신 프로토콜
...
![PDF 페이지 431의 원문 점검항목 영역](../assets/n-17/n-17-page-431-source-region.png)
...
![PDF 페이지 432의 원문 점검항목 영역](../assets/n-17/n-17-page-432-source-region.png)
