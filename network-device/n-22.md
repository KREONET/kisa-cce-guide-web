...
점검 목적
인프라를 보호함
보안 위협 IP 스푸핑 기반 DoS 공격 트래픽이 네트워크 장비의 한계용량을 초과하는 경우 정상적인 서비스 불가
...
![PDF 페이지 441의 원문 점검항목 영역](../assets/n-22/n-22-page-441-source-region.png)
...
![PDF 페이지 442의 원문 점검항목 영역](../assets/n-22/n-22-page-442-source-region.png)
...
![PDF 페이지 443의 원문 점검항목 영역](../assets/n-22/n-22-page-443-source-region.png)
