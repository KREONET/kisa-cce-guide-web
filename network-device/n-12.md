...
classification:
  ...
  categoryIdentifier: network-device-patch-management
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 422
      physicalPageEnd: 423
      printedPageStart: "422"
      printedPageEnd: "423"

sourceAnnotations:
  - annotationIdentifier: n-12-source-001
    annotationType: sourceTypographicalError
    targetType: astNode
    targetReference: "n-12:remediation.supplementaryGuidance.step:14"
    sourceLocation:
      physicalPage: 423
      printedPage: "423"
      pageRegionIdentifier: p423-n-12
    sourceText: "패치 적용 후 모든 인터페이스와 중요 호스트로의 통신이 정상 동작하는지 확인)"
    explanation: "문장 끝에 대응하는 여는 괄호가 없는 닫는 괄호가 있다."
    disposition: preserved
    reviewStatus: pending
    verificationEvidence:
      - "PDF physical page 423의 Step 5 항목 3을 확인했다."
    reviewedBy: null
    reviewedAt: null
    approvedBy: null
    approvedAt: null
