...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 397
      physicalPageEnd: 398
      printedPageStart: '397'
      printedPageEnd: '398'
sourceAnnotations:
  - annotationIdentifier: n-03-inventory-001
    ...
    sourceLocation:
      physicalPage: 397
      printedPage: '397'
      pageRegionIdentifier: p397-n-03
    sourceText: 암호화된 비밀번호 사용
    explanation: '{"anomalyType": "detailHeaderTitleMismatch", "code": "N-03", "detailHeaderTitle": "암호화된 비밀번호 사용", "physicalPage": 397, "resolution": "Use the detailed criterion heading as the canonical title and preserve the chapter summary value as an annotation.", "summaryTitle": "암호화된 비밀번호 가용"}'
...
![PDF 페이지 397의 원문 점검항목 영역](../assets/n-03/n-03-page-397-source-region.png)
...
![PDF 페이지 398의 원문 점검항목 영역](../assets/n-03/n-03-page-398-source-region.png)
