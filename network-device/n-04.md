...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 399
      physicalPageEnd: 400
      printedPageStart: '399'
      printedPageEnd: '400'
sourceAnnotations: []
---
...
보안 위협 가능하고 비밀번호 탈취 공격(무차별 대입 공격, 사전 대입 공격 등)의 인증 요청에 대해 설정된
...
![PDF 페이지 399의 원문 점검항목 영역](../assets/n-04/n-04-page-399-source-region.png)
...
![PDF 페이지 400의 원문 점검항목 영역](../assets/n-04/n-04-page-400-source-region.png)
