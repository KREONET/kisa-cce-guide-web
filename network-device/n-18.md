...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 433
      physicalPageEnd: 434
      printedPageStart: '433'
      printedPageEnd: '434'
sourceAnnotations: []
---
...
보안 위협 취약점으로 인한 공격이 가능하며, 네트워크 서비스의 경우 열린 포트를 통한 외부 침입의 위험이
존재함
...
조치 방법 ※ SNMP Community String 복잡성 기준 : 영어 대·소문자, 숫자, 특수문자 중 3종류 이상을
조합하여 8자리 이상으로 구성
...
![PDF 페이지 433의 원문 점검항목 영역](../assets/n-18/n-18-page-433-source-region.png)
...
![PDF 페이지 434의 원문 점검항목 영역](../assets/n-18/n-18-page-434-source-region.png)
