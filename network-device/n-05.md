...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 401
      physicalPageEnd: 405
      printedPageStart: '401'
      printedPageEnd: '405'
sourceAnnotations:
  - annotationIdentifier: n-05-inventory-001
    ...
    sourceLocation:
      physicalPage: 401
      printedPage: '401'
      pageRegionIdentifier: p401-n-05
    sourceText: 사용자·명령어별 권한 설정
    explanation: '{"anomalyType": "detailHeaderTitleMismatch", "code": "N-05", "detailHeaderTitle": "사용자·명령어별 권한 설정", "physicalPage": 401, "resolution": "Use the detailed criterion heading as the canonical title and preserve the chapter summary value as an annotation.", "summaryTitle": "사용자, 명령어별 권한 수준 설정"}'
...
![PDF 페이지 401의 원문 점검항목 영역](../assets/n-05/n-05-page-401-source-region.png)
...
![PDF 페이지 402의 원문 점검항목 영역](../assets/n-05/n-05-page-402-source-region.png)
...
SLB Operator / slboper 부가적으로 모든 스위치 정보와 통계를 볼 수 있으며, Server Load Balancing 운영
...
SLB Administrator / 관리 할 수 있음
slbadmin 부가적으로 SLB Operator 기능들과 설정 필터들이나 대역폭 관리를 하는 것을 제외한
Server Load Balancing 메뉴에 매개변수를 설정할 수 있음
Layer4 Administrator는 공유된 인터넷 서비스들에 따른 라인에 대한 트래픽을 설정 및
Layer4 Administrator / 관리함
l4admin 부가적으로 SLB Administrator 기능들, 설정 필터들이나 대역폭 관리 하는 것을 포함한
...
![PDF 페이지 403의 원문 점검항목 영역](../assets/n-05/n-05-page-403-source-region.png)
...
![PDF 페이지 404의 원문 점검항목 영역](../assets/n-05/n-05-page-404-source-region.png)
...
![PDF 페이지 405의 원문 점검항목 영역](../assets/n-05/n-05-page-405-source-region.png)
