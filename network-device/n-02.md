...
점검 내용 비밀번호 복잡성 정책 설정 기능이 장비에 존재하지 않는 경우 기관 정책에 맞게 계정 비밀번호를
설정하여 사용하는지 점검
...
보안 위협 pass1234 등)를 설정할 수 있도록 허용되므로, 해당 취약점으로 인해 비인가자의 공격(무차별 대입
...
![PDF 페이지 395의 원문 점검항목 영역](../assets/n-02/n-02-page-395-source-region.png)
...
![PDF 페이지 396의 원문 점검항목 영역](../assets/n-02/n-02-page-396-source-region.png)
