...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 519
      ...
      printedPageEnd: '520'
sourceAnnotations:
  - annotationIdentifier: c-27-inventory-001
    ...
    sourceLocation:
      physicalPage: 519
      printedPage: '519'
      pageRegionIdentifier: p519-c-27
...
보안 위협 제어시스템의 장애 또는 정지 등의 피해가 발생할 위험이 존재함
...
![PDF 페이지 519의 원문 점검항목 영역](../assets/c-27/c-27-page-519-source-region.png)

### PDF 페이지 520

~~~text transcription
[ 네트워크 포트 봉인 예시 ] [ USB 포트 봉인 예시 ]
Step 2) 물리적 봉인이 되지 않은 제어시스템 구성요소의 미사용 인터페이스(네트워크 포트, USB 포트 등)에
대한 논리적 차단 여부 확인
[ 네트워크 장비 미사용 인터페이스 비활성화(shutdown) 예시 ]
~~~

![PDF 페이지 520의 원문 점검항목 영역](../assets/c-27/c-27-page-520-source-region.png)
