...
criterion:
  code: C-51
  slug: c-51
  title: 제어시스템 운전원, 관리자, 유지보수인력, 보안 인력에 대해 직무별 직무교육을 정기적으로 실시
  severity:
    level: low
    sourceLabel: 하
classification:
  domainIdentifier: control-system
  categoryIdentifier: control-system-education-training
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 551
      physicalPageEnd: 551
      printedPageStart: '551'
      printedPageEnd: '551'
sourceAnnotations:
  - annotationIdentifier: c-51-inventory-001
    ...
    sourceLocation:
      physicalPage: 551
      printedPage: '551'
      pageRegionIdentifier: p551-c-51
    sourceText: 교육훈련
    explanation: '{"affectedCodes": ["C-51"], "anomalyType": "detailHeaderCategoryMismatch", "detailHeaderCategoryOrdinal": 9, "detailHeaderCategorySourceLabel": "교육훈련", "summaryCategoryOrdinal": 9, "summaryCategorySourceLabel": "교육 훈련"}'
...
~~~text transcription
개요
점검 내용 제어시스템의 장애 발생, 사이버 공격, 물리적 테러 등에 대비한 정기적인 비상계획 훈련 실시 여부 점검
...
보안 위협 비상계획에 따른 적절한 대응 및 조치가 이루어지지 않아 제어시스템의 운영이 불가능할 수 있고 이에
...
![PDF 페이지 551의 원문 점검항목 영역](../assets/c-51/c-51-page-551-source-region.png)
