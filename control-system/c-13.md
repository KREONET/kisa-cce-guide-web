...
점검 목적 제어할 수 있으므로 제어 명령 제한과 파라미터값의 범위를 제한하여 운영자의 부주의(Human Error),
...
오작동 등의 피해가 발생할 수 있음
보안 위협 Ÿ 위협 사례: 스턱스넷은 PLC 시스템의 Profibus 메시지 버스 시스템을 감시하는 D8890 블록에
...
참고 제한하여 운영자 권한 또는 악성코드에 의해 불필요한 제어 명령과 파라미터값 전송이 일어나지
...
![PDF 페이지 497의 원문 점검항목 영역](../assets/c-13/c-13-page-497-source-region.png)
