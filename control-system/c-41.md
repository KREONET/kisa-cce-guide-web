...
targetIdentifiers:
  ...
  - aix
  - hp-ux
sourceTargetText: "제어시스템 설치장소 전체"
...
1. 제어시스템 설치 장소에 누수, 침수 등의 탐지설비를 구축하고 있는지 확인하고 없는 경우 구비하도록 조치
2. 제어시스템 설치 장소에 침수 시 대응을 위한 방수포, 배수펌프 등이 구비되어 있는지 확인하고 없는 경우 구비하도록 조치
