...
~~~text transcription
개요
점검 내용 제어기기의 로직 변경에 대한 사전 검토 및 허가를 포함하는 로직 변경 정책 수립 및 이행 여부 점검
내부자(현장 엔지니어, 유지보수 작업자)에 의해서 검증되지 않은 로직이 제어기기에 다운로드 시
점검 목적 발생할 수 있는 제어시스템 오동작 문제를 차단하고, 제어기기의 세밀한 형상관리를 통해 제어시스템의
...
[ PLC 동작 구조 ]
점검 대상 및 판단 기준
대상 PLC, DCS 컨트롤러 등 로직에 의해서 동작하는 제어시스템 구성요소 전체
...
![PDF 페이지 549의 원문 점검항목 영역](../assets/c-50/c-50-page-549-source-region.png)
...
[ 제어 S/W를 통한 제어기기의 로그 확인 예시 ] [ 제어 S/W의 로그 확인 예시 ]
~~~

![PDF 페이지 550의 원문 점검항목 영역](../assets/c-50/c-50-page-550-source-region.png)
