...
~~~text transcription
개요
점검 내용 제어시스템의 장애, 사이버 공격, 물리적 테러 등이 발생하는 경우에 대비한 비상계획 수립 여부 점검
...
참고 비상상황에 대비한 재난관리체계, 재난대응절차, 프로세스 및 장애의 종류에 따른 대응방안과
...
![PDF 페이지 529의 원문 점검항목 영역](../assets/c-34/c-34-page-529-source-region.png)
