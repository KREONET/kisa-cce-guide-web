...
criterion:
  code: C-30
  slug: c-30
  title: 이상 트래픽 발생 탐지 등 제어시스템 내의 보안 관리를 위해 적합한 침입탐지시스템 등을 구축 및 운용하고, 구축된 보안 솔루션 및 보안 장비에서 탐지한 보안 이벤트에 대해 모니터링 수행
  severity:
    level: low
    sourceLabel: 하
...
targetIdentifiers:
  ...
  - aix
  - hp-ux
sourceTargetText: "제어망 네트워크"

provenance:
  sourceDocumentIdentifier: kisa-cce-criteria-2026
  sourcePageRanges:
    - physicalPageStart: 524
      physicalPageEnd: 524
      printedPageStart: "524"
      printedPageEnd: "524"
...
1. 제어시스템 구성요소 현황(목록)을 활용하여 제어시스템 이상 트래픽 발생 탐지 등을 위한 장비(침입탐지시스템 등) 구축 유무를 확인
2. Step 1) 에서 확인한 구축 장비를 활용하여 탐지한 보안 이벤트를 모니터링하는지 확인
