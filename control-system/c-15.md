...
criterion:
  code: C-15
  slug: c-15
  title: GPS 스푸핑/재밍 공격 등 시간 동기화 서비스를 교란하기 위한 공격에 대비한 보안 조치 수행
  severity:
    level: low
    sourceLabel: 하
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 499
      physicalPageEnd: 499
      printedPageStart: '499'
      printedPageEnd: '499'
sourceAnnotations:
  - annotationIdentifier: c-15-inventory-001
    ...
    sourceLocation:
      physicalPage: 499
      printedPage: '499'
      pageRegionIdentifier: p499-c-15
    sourceText: GPS 스푸핑/재밍 공격 등 시간 동기화 서비스를 교란하기 위한 공격에 대비한 보안 조치 수행
    explanation: '{"anomalyType": "detailHeaderTitleMismatch", "code": "C-15", "detailHeaderTitle": "GPS 스푸핑/재밍 공격 등 시간 동기화 서비스를 교란하기 위한 공격에 대비한 보안 조치 수행", "physicalPage": 499, "resolution": "Use the detailed criterion heading as the canonical title and preserve the chapter summary value as an annotation.", "summaryTitle": "GPS 스푸핑/재밍 공격 등 시각 동기화 서비스를 교란하기 위한 공격에 대비한 보안 조치 수행"}'
...
~~~text transcription
개요
점검 내용 제어시스템에 구축한 시간 동기화 시스템이 GPS 스푸핑/재밍 공격 등에 대응하는 기능 존재 여부 점검
...
![PDF 페이지 499의 원문 점검항목 영역](../assets/c-15/c-15-page-499-source-region.png)
