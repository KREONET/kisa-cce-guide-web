...
점검 목적 제어시스템에 인터넷을 통한 각종 침해위협(예시: 악성코드 등)으로부터 보호하기 위함
...
조치 방법 제어시스템 운영망과 업무망 분리 및 인터넷 차단
...
![PDF 페이지 507의 원문 점검항목 영역](../assets/c-21/c-21-page-507-source-region.png)
...
![PDF 페이지 508의 원문 점검항목 영역](../assets/c-21/c-21-page-508-source-region.png)
