...
유·무선 인터넷 접속이 가능한 경우
조치 방법 외부 연계 접점 차단 설정(외부 연계일 경우 물리적 일방향 시스템 적용)
조치 시 영향 일반적인 경우 영향 없음
~~~

![PDF 페이지 511의 원문 점검항목 영역](../assets/c-23/c-23-page-511-source-region.png)
...
![PDF 페이지 512의 원문 점검항목 영역](../assets/c-23/c-23-page-512-source-region.png)
