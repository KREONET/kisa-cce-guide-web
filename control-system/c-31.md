...
criterion:
  code: C-31
  slug: c-31
  title: 제어시스템 대상 사이버 위기대응 매뉴얼을 수립
  severity:
    level: high
    sourceLabel: 상
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 525
      physicalPageEnd: 526
      printedPageStart: '525'
      printedPageEnd: '526'
sourceAnnotations: []
---
...
~~~text transcription
개요
점검 내용 제어시스템 대상 사이버 침해사고 발생 시 대응을 위한 사이버 위기대응 매뉴얼 수립 여부 점검
...
조치 방법 제어시스템 환경에 맞는 사이버 위기대응 매뉴얼을 수립(문서화)하고 정기적 또는 주기적인 개정(현행화) 적용
...
![PDF 페이지 525의 원문 점검항목 영역](../assets/c-31/c-31-page-525-source-region.png)
...
![PDF 페이지 526의 원문 점검항목 영역](../assets/c-31/c-31-page-526-source-region.png)
