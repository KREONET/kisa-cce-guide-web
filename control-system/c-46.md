...
criterion:
  code: C-46
  slug: c-46
  title: 제어 네트워크에 연결되는 외부 정보통신기기 반‧출입 시 클린존 통과, 관리대장 작성 등 관리절차 마련
  severity:
    level: high
    sourceLabel: 상
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 544
      physicalPageEnd: 544
      printedPageStart: '544'
      printedPageEnd: '544'
sourceAnnotations:
  - annotationIdentifier: c-46-inventory-001
    ...
    sourceLocation:
      physicalPage: 544
      printedPage: '544'
      pageRegionIdentifier: p544-c-46
    sourceText: 복구 대응
...
![PDF 페이지 544의 원문 점검항목 영역](../assets/c-46/c-46-page-544-source-region.png)
