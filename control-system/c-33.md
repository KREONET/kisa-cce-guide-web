...
criterion:
  code: C-33
  slug: c-33
  title: 제어시스템 침해사고 대응을 위한 제어시스템 설정, 중요 데이터 등을 백업 및 관리
  severity:
    level: high
    sourceLabel: 상
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 528
      physicalPageEnd: 528
      printedPageStart: '528'
      printedPageEnd: '528'
sourceAnnotations: []
---
...
참고 제어 로직, PC, 서버 관련 데이터, 설정 정보 등 제어시스템의 복구에 필요한 중요 정보를 백업하고
관리하는지 확인함
점검 대상 및 판단 기준
대상 제어시스템 구성요소 전체
...
조치 방법 제어시스템 구성요소의 설정 및 중요 데이터 등을 주기적으로 백업 및 관리하도록 조치
...
![PDF 페이지 528의 원문 점검항목 영역](../assets/c-33/c-33-page-528-source-region.png)
