...
criterion:
  code: C-14
  slug: c-14
  title: 제어시스템 내 사용자 통신 세션에 대해 세션 타임아웃 적용
  severity:
    level: low
    sourceLabel: 하
classification:
...
~~~text transcription
개요
점검 내용 세션 통신을 지원하는 제어시스템 구성요소의 합리적인 시간 범위 내에 세션 타임아웃 설정 운용 여부 점검
...
![PDF 페이지 498의 원문 점검항목 영역](../assets/c-14/c-14-page-498-source-region.png)
