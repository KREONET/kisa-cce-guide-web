...
targetIdentifiers:
  ...
  - aix
  - hp-ux
sourceTargetText: "제어시스템 관련 운영조직 전체"
...
비상계획 훈련을 정기적으로 실시하지 않는 경우 제어시스템의 장애 등이 발생하는 상황에서 비상계획에 따른 적절한 대응 및 조치가 이루어지지 않아 제어시스템의 운영이 불가능할 수 있고 이에 따른 경제적, 사회적 손실 발생이 발생할 위험이 존재함
