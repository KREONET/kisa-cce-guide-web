...
criterion:
  code: C-35
  slug: c-35
  title: 제어시스템의 장애 발생, 사이버 공격, 물리적 테러 등에 대한 비상계획 훈련을 정기적으로 시행
  severity:
    level: medium
    sourceLabel: 중
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 530
      physicalPageEnd: 530
      printedPageStart: '530'
      printedPageEnd: '530'
sourceAnnotations: []
---
...
보안 위협 따른 적절한 대응 및 조치가 이루어지지 않아 제어시스템의 운영이 불가능할 수 있고 이에 따른 경제적,
...
![PDF 페이지 530의 원문 점검항목 영역](../assets/c-35/c-35-page-530-source-region.png)
