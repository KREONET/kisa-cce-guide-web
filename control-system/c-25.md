...
criterion:
  code: C-25
  slug: c-25
  title: 물리적 일방향 자료전달 환경의 올바른 동작 및 운용에 대한 주기적인 점검 수행
  severity:
    level: high
    sourceLabel: 상
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 515
      physicalPageEnd: 516
      printedPageStart: '515'
      printedPageEnd: '516'
sourceAnnotations: []
---
...
보안 위협 또는 오·남용(예시: 운전 조작 등) 우려가 있고, 악성코드가 유입되는 경우 제어망에 위치한 시스템까지
감염될 수 있음
...
조치 방법
접근통제 정책(Rule) 설정
조치 시 영향 현재 제어시스템 내 운영 서비스에 대한 정확한 파악이 안될 경우, 장애 발생 가능
점검 및 조치 사례
l 공통
...
![PDF 페이지 515의 원문 점검항목 영역](../assets/c-25/c-25-page-515-source-region.png)
...
![PDF 페이지 516의 원문 점검항목 영역](../assets/c-25/c-25-page-516-source-region.png)
