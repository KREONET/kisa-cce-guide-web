...
점검 목적 있고 해당 구성요소의 신규 구축, 변경 등에 따라서 제어시스템의 일부 또는 전체의 오작동이 발생할 수
...
조치 방법 제어시스템의 변경사항을 테스트할 수 있는 테스트베드 구축
...
![PDF 페이지 506의 원문 점검항목 영역](../assets/c-20/c-20-page-506-source-region.png)
