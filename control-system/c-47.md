...
criterion:
  code: C-47
  slug: c-47
  title: 제어시스템의 특성을 반영한 정보보안 정책, 지침을 수립
  severity:
    level: medium
    sourceLabel: 중
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 545
      physicalPageEnd: 546
      printedPageStart: '545'
      printedPageEnd: '546'
sourceAnnotations:
  - annotationIdentifier: c-47-inventory-001
    ...
    sourceLocation:
      physicalPage: 545
      printedPage: '545'
      pageRegionIdentifier: p545-c-47
    sourceText: 복구 대응
...
~~~text transcription
개요
점검 내용 제어시스템의 특성을 반영한 정보보안 정책 및 지침 수립 여부 점검
...
보안 위협 누락되어 운영인력의 부주의(Human Error) 또는 운영상의 취약점을 악용한 사이버 침해위협이 발생할
위험이 존재함
※ 제어시스템 특성
...
조치 방법 제어시스템의 특성을 반영한 정보보안 정책 및 지침을 수립
조치 시 영향 일반적인 경우 영향 없음
~~~

![PDF 페이지 545의 원문 점검항목 영역](../assets/c-47/c-47-page-545-source-region.png)
...
![PDF 페이지 546의 원문 점검항목 영역](../assets/c-47/c-47-page-546-source-region.png)
