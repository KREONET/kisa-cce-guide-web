...
criterion:
  code: C-04
  slug: c-04
  title: 제어시스템 계정을 관리, 운영, 유지보수 등 용도에 따라 분리하고 운용
  severity:
    level: medium
    sourceLabel: 중
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 479
      physicalPageEnd: 479
      printedPageStart: '479'
      printedPageEnd: '479'
sourceAnnotations: []
---
...
보안 위협 기기의 오작동 발생할 수 있으며 사고 발생 시 사고 원인 파악 및 향후 예방 활동에 필수적인 사고 분석
제한의 위험이 존재함
...
조치 방법 계정 기능을 사용하는 제어시스템 구성요소에서 용도별로 계정을 분리하여 운영하도록 설정
...
![PDF 페이지 479의 원문 점검항목 영역](../assets/c-04/c-04-page-479-source-region.png)
