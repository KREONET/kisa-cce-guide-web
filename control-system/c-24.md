...
criterion:
  code: C-24
  slug: c-24
  title: 제어 네트워크에 비인가된 시스템/기기에 대한 연결 및 접속을 차단
  severity:
    level: high
    sourceLabel: 상
classification:
...
~~~text transcription
개요
점검 내용 제어 네트워크에 비인가된 시스템/기기 등을 연결하는 경우의 연결 및 접속 차단 여부 점검
점검 목적 출입자가 비인가 기기, 서버 및 노트북 등을 반입하여 임의로 제어 네트워크에 연결할 수 없도록 하기 위함
...
참고 등이 반입되고 이를 손쉽게 제어 네트워크에 연결하는 것을 차단하기 위해서는 비인가 기기의
...
조치 방법
의한 접근통제 조치 설정
조치 시 영향 현재 제어시스템 내 운영 서비스에 대한 정확한 파악이 되지 않은 경우, 장애 발생 가능
~~~

![PDF 페이지 513의 원문 점검항목 영역](../assets/c-24/c-24-page-513-source-region.png)
...
![PDF 페이지 514의 원문 점검항목 영역](../assets/c-24/c-24-page-514-source-region.png)
