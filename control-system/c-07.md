...
criterion:
  code: C-07
  slug: c-07
  title: 제어시스템 구성요소에 대한 시각 동기화 수행
  severity:
    level: high
    sourceLabel: 상
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 484
      physicalPageEnd: 486
      printedPageStart: '484'
      printedPageEnd: '486'
sourceAnnotations:
  - annotationIdentifier: c-07-inventory-001
    ...
    sourceLocation:
      physicalPage: 484
      printedPage: '484'
      pageRegionIdentifier: p484-c-07
    sourceText: 제어시스템 구성요소에 대한 시각 동기화 수행
    explanation: '{"anomalyType": "detailHeaderTitleMismatch", "code": "C-07", "detailHeaderTitle": "제어시스템 구성요소에 대한 시각 동기화 수행", "physicalPage": 484, "resolution": "Use the detailed criterion heading as the canonical title and preserve the chapter summary value as an annotation.", "summaryTitle": "제어시스템 구성요소에 대한 시간 동기화 수행"}'
...
~~~text transcription
개요
점검 내용 제어시스템 구성요소들이 같은 시간을 유지할 수 있도록 하는 시각 동기화 기능의 제공 여부 점검
...
보안 위협 있으며 제어시스템의 로그 분석이 어려워 이로 인해 공격자가 발각되지 않고 공격 기법을 숨기는 등의
위험이 존재함
...
![PDF 페이지 484의 원문 점검항목 영역](../assets/c-07/c-07-page-484-source-region.png)
...
![PDF 페이지 485의 원문 점검항목 영역](../assets/c-07/c-07-page-485-source-region.png)
...
![PDF 페이지 486의 원문 점검항목 영역](../assets/c-07/c-07-page-486-source-region.png)
