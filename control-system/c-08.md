...
~~~text transcription
개요
점검 내용 제어시스템 구성요소에서 불필요한 서비스와 취약한 서비스를 제거하거나 이용할 수 없도록 비활성화 여부 점검
...
보안 위협 사용하는 SMB(Server Message Block) 프로토콜을 악용하여, 해당 네트워크 트래픽을 해커가
...
![PDF 페이지 487의 원문 점검항목 영역](../assets/c-08/c-08-page-487-source-region.png)
...
조치 방법 제어시스템에 불필요하거나 취약한 서비스를 제거 또는 비활성화 설정
...
![PDF 페이지 488의 원문 점검항목 영역](../assets/c-08/c-08-page-488-source-region.png)
...
![PDF 페이지 489의 원문 점검항목 영역](../assets/c-08/c-08-page-489-source-region.png)
