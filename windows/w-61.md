...
조치 방법 FAT 파일 시스템을 사용 시 가능한 NTFS 파일 시스템 변환 설정
조치 시 영향 파일 시스템을 변환할 경우 기존 파일 시스템에 영향을 줄 수 있음
점검 및 조치 사례
...
![PDF 페이지 267의 원문 점검항목 영역](../assets/w-61/w-61-page-267-source-region.png)
