...
![PDF 페이지 200의 원문 점검항목 영역](../assets/w-18/w-18-page-200-source-region.png)
...
![PDF 페이지 201의 원문 점검항목 영역](../assets/w-18/w-18-page-201-source-region.png)
...
Automatic Updates 패치를 적용하거나, MS 패치 관리 서버로 패치를 일괄적으로 관리하는 경우 불필요한
서비스
...
DHCP Client 가져오는 기능을 수행. 단독으로 시스템을 수행하며 고정 IP를 사용하는 경우 불필요한
서비스
...
![PDF 페이지 202의 원문 점검항목 영역](../assets/w-18/w-18-page-202-source-region.png)
...
![PDF 페이지 203의 원문 점검항목 영역](../assets/w-18/w-18-page-203-source-region.png)
