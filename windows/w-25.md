...
점검 목적 DNS Zone Transfer 차단 설정을 적용하여 도메인 정보의 불법 외부 유출을 방지하기 위함
...
![PDF 페이지 214의 원문 점검항목 영역](../assets/w-25/w-25-page-214-source-region.png)
...
![PDF 페이지 215의 원문 점검항목 영역](../assets/w-25/w-25-page-215-source-region.png)
