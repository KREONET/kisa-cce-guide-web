...
조치 방법 불필요 시 서비스 중지 및 사용 안 함으로 설정
...
![PDF 페이지 241의 원문 점검항목 영역](../assets/w-44/w-44-page-241-source-region.png)
