...
~~~text transcription
개요
점검 내용 Session 연결 중단 시 유휴 시간 설정 여부 점검
...
보안 위협 서버에 오류를 발생시킬 수 있으므로 공격자는 이를 악용하여 SMB Session을 반복 설정하여 서버의
...
참고 값을 0으로 설정하면 가능한 한 빨리 유휴 Session 연결은 끊어지며, 최댓값은 99999(208일)로
사실상 정책 설정 해제를 의미함
...
![PDF 페이지 257의 원문 점검항목 영역](../assets/w-56/w-56-page-257-source-region.png)
...
![PDF 페이지 258의 원문 점검항목 영역](../assets/w-56/w-56-page-258-source-region.png)
