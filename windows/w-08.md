...
~~~text transcription
개요
점검 내용 사용자 계정 잠금 기간 정책 설정 여부 점검
...
판단 기준 취약 : “계정 잠금 기간” 및 “잠금 기간 원래대로 설정 기간”이 설정되지 않거나 60분 미만으로 설정된
경우
조치 방법 “계정 잠금 기간” 및 “잠금 기간 원래대로 설정 기간” 60분 이상으로 설정
...
![PDF 페이지 185의 원문 점검항목 영역](../assets/w-08/w-08-page-185-source-region.png)
...
![PDF 페이지 186의 원문 점검항목 영역](../assets/w-08/w-08-page-186-source-region.png)
