...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 251
      physicalPageEnd: 252
      printedPageStart: '251'
      printedPageEnd: '252'
sourceAnnotations: []
---
...
참고 ※ 네트워크 및 전화 접속 연결 > 로컬 영역 > 등록 정보 > 고급 > 고급 설정 > Microsoft 네트워크 파일
및 프린트 공유를 해제해야 함
점검 대상 및 판단 기준
...
![PDF 페이지 251의 원문 점검항목 영역](../assets/w-51/w-51-page-251-source-region.png)
...
![PDF 페이지 252의 원문 점검항목 영역](../assets/w-51/w-51-page-252-source-region.png)
