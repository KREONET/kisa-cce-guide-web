...
~~~text transcription
개요
점검 내용 도메인 컨트롤러와 사용자의 시간 동기화 여부 점검
...
조치 방법 Kerberos 사용 시 컴퓨터 시계 동기화 최대 허용 오차값 5분 이하로 설정
...
![PDF 페이지 269의 원문 점검항목 영역](../assets/w-63/w-63-page-269-source-region.png)
