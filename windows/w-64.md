...
~~~text transcription
개요
점검 내용 시스템의 방화벽 기능이 활성화되어 있는지 점검
...
참고 입으로부터 내부의 정보 자산을 보호하고 외부로부터 유해 정보 유입을 차단하기 위한 정책과 이를
...
![PDF 페이지 270의 원문 점검항목 영역](../assets/w-64/w-64-page-270-source-region.png)
