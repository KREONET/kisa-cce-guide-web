...
~~~text transcription
개요
점검 내용 시스템 로깅 설정 여부 및 적절성 점검
점검 목적 적절한 로깅 설정으로 유사시 책임 추적을 위한 로그를 확보하기 위함
...
![PDF 페이지 235의 원문 점검항목 영역](../assets/w-40/w-40-page-235-source-region.png)
...
![PDF 페이지 236의 원문 점검항목 영역](../assets/w-40/w-40-page-236-source-region.png)
