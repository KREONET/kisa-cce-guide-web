...
~~~text transcription
개요
점검 내용 시스템 내 FTP 서비스 구동 여부 점검
점검 목적 인증정보가 기본적으로 평문 전송되는 취약한 프로토콜인 FTP의 사용을 제한하기 위함
...
조치 방법 FTP 서비스가 필요하지 않다면 서비스 중지 또는 Secure FTP 응용 프로그램 사용
...
![PDF 페이지 207의 원문 점검항목 영역](../assets/w-21/w-21-page-207-source-region.png)
