...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 181
      physicalPageEnd: 181
      printedPageStart: '181'
      printedPageEnd: '181'
sourceAnnotations: []
---
...
조치 방법 “해독 가능한 암호화를 사용하여 암호 저장”을 “사용 안 함”으로 설정
...
![PDF 페이지 181의 원문 점검항목 영역](../assets/w-05/w-05-page-181-source-region.png)
