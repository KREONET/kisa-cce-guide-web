...
~~~text transcription
개요
점검 내용 원격 데스크톱 서비스 암호화 수준 적절성 점검
...
![PDF 페이지 218의 원문 점검항목 영역](../assets/w-28/w-28-page-218-source-region.png)
...
![PDF 페이지 219의 원문 점검항목 영역](../assets/w-28/w-28-page-219-source-region.png)
