...
~~~text transcription
개요
점검 내용 ‘보안 감사를 로그 할 수 없는 경우 즉시 시스템 종료’ 정책 설정 여부 점검
...
조치 방법 “보안 감사를 로그 할 수 없는 경우 즉시 시스템 종료” 정책을 “사용 안 함”으로 설정
...
![PDF 페이지 249의 원문 점검항목 영역](../assets/w-50/w-50-page-249-source-region.png)
...
![PDF 페이지 250의 원문 점검항목 영역](../assets/w-50/w-50-page-250-source-region.png)
