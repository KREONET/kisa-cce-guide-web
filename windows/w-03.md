...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 179
      physicalPageEnd: 179
      printedPageStart: "179"
      printedPageEnd: "179"
...
1. **Windows NT — Step 1:** 시작 > 프로그램 > 관리 도구 > 도메인 사용자 관리 > 계정 선택 > 등록 정보
2. **Windows NT — Step 2:** “계정 사용 안 함” 설정 또는 계정 삭제
3. **Windows 2000, 2003, 2008, 2012, 2016, 2019, 2022 — Step 1:** 시작 > 제어판 > 관리 도구 > 컴퓨터 관리 > 로컬 사용자 및 그룹 > 사용자
4. **Windows 2000, 2003, 2008, 2012, 2016, 2019, 2022 — Step 2:** 등록된 계정 중 불필요한 사용자 선택 > 속성 > “계정 사용 안 함” 설정 또는 계정 삭제
