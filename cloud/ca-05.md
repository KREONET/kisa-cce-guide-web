...
~~~text transcription
개요
점검 내용 인스턴스 생성 또는 접근 권한 설정 여부 점검
점검 목적 인스턴스 생성 또는 접근 권한을 점검하여 인스턴스 내부 정보 유출을 방지하기 위함
...
조치 방법 인스턴스 생성 및 접근 권한을 관리자 계정에 별도로 부여
...
![PDF 페이지 858의 원문 점검항목 영역](../assets/ca-05/ca-05-page-858-source-region.png)
