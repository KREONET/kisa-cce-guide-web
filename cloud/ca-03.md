...
criterion:
  code: CA-03
  slug: ca-03
  title: MFA(Multi-Factor Authentication) 설정
  severity:
    level: high
    sourceLabel: 상
classification:
  domainIdentifier: cloud
  categoryIdentifier: cloud-account-management
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 856
      physicalPageEnd: 856
      printedPageStart: '856'
      printedPageEnd: '856'
sourceAnnotations: []
---
...
보안 위협 공격으로 인해 계정이 탈취되어 중요 데이터 유출 및 로그 변조 등의 시스템 악용이 발생할 위험이
존재함
참고 -
점검 대상 및 판단 기준
대상 클라우드 플랫폼
...
![PDF 페이지 856의 원문 점검항목 영역](../assets/ca-03/ca-03-page-856-source-region.png)
