...
~~~text transcription
개요
점검 내용 내부 클라우드 리소스 접근 시 접근통제 적용 여부 점검
...
조치 방법 서비스 리소스에 공인 IP주소 제거 및 관리자만 접근할 수 있도록 접근권한 설정
...
![PDF 페이지 861의 원문 점검항목 영역](../assets/ca-08/ca-08-page-861-source-region.png)
