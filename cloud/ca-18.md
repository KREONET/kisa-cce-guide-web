...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 871
      physicalPageEnd: 871
      printedPageStart: '871'
      printedPageEnd: '871'
sourceAnnotations: []
---
...
~~~text transcription
개요
점검 내용 클라우드 리소스에 대한 백업 수행 여부 점검
...
![PDF 페이지 871의 원문 점검항목 영역](../assets/ca-18/ca-18-page-871-source-region.png)
