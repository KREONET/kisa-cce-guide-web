...
보안 위협 오류를 유발하여, 중요 페이지에 대한 URL 직접 접근, 가격 변조 등의 다양한 행위가 가능하며 서비스
제공에 불이익이 발생할 수 있음
참고 ※ 소스코드 및 취약점 점검 필요
점검 대상 및 판단 기준
대상 웹 애플리케이션 소스코드
...
![PDF 페이지 739의 원문 점검항목 영역](../assets/pv/pv-page-739-source-region.png)
...
![PDF 페이지 740의 원문 점검항목 영역](../assets/pv/pv-page-740-source-region.png)
...
![PDF 페이지 741의 원문 점검항목 영역](../assets/pv/pv-page-741-source-region.png)
...
![PDF 페이지 742의 원문 점검항목 영역](../assets/pv/pv-page-742-source-region.png)
...
![PDF 페이지 743의 원문 점검항목 영역](../assets/pv/pv-page-743-source-region.png)
