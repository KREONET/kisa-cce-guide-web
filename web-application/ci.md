...
classification:
  ...
  categoryIdentifier: web-application-code-injection
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 679
      physicalPageEnd: 692
      printedPageStart: '679'
      printedPageEnd: '692'
sourceAnnotations: []
---
...
보안 위협 정보의 신뢰성이 떨어지며, 서비스 거부 공격(DoS)으로 시스템 가용성이 저하될 수 있음. 따라서 "|",
...
참고 ※ XPath 인젝션: 입력값이 XPath 쿼리에 삽입되어 XML 데이터의 비인가된 조회, 추가, 삭제를
유발하는 공격
...
![PDF 페이지 679의 원문 점검항목 영역](../assets/ci/ci-page-679-source-region.png)
...
![PDF 페이지 680의 원문 점검항목 영역](../assets/ci/ci-page-680-source-region.png)
...
![PDF 페이지 681의 원문 점검항목 영역](../assets/ci/ci-page-681-source-region.png)
...
![PDF 페이지 682의 원문 점검항목 영역](../assets/ci/ci-page-682-source-region.png)
...
![PDF 페이지 683의 원문 점검항목 영역](../assets/ci/ci-page-683-source-region.png)
...
![PDF 페이지 684의 원문 점검항목 영역](../assets/ci/ci-page-684-source-region.png)
...
![PDF 페이지 685의 원문 점검항목 영역](../assets/ci/ci-page-685-source-region.png)
...
![PDF 페이지 686의 원문 점검항목 영역](../assets/ci/ci-page-686-source-region.png)
...
![PDF 페이지 687의 원문 점검항목 영역](../assets/ci/ci-page-687-source-region.png)
...
![PDF 페이지 688의 원문 점검항목 영역](../assets/ci/ci-page-688-source-region.png)
...
![PDF 페이지 689의 원문 점검항목 영역](../assets/ci/ci-page-689-source-region.png)
...
![PDF 페이지 690의 원문 점검항목 영역](../assets/ci/ci-page-690-source-region.png)
...
![PDF 페이지 691의 원문 점검항목 영역](../assets/ci/ci-page-691-source-region.png)
...
![PDF 페이지 692의 원문 점검항목 영역](../assets/ci/ci-page-692-source-region.png)
