...
classification:
  ...
  categoryIdentifier: web-application-insufficient-authorization
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 733
      physicalPageEnd: 734
      printedPageStart: '733'
      printedPageEnd: '734'
sourceAnnotations: []
---
...
보안 위협 타 사용자의 권한을 탈취할 경우, 개인정보 유출 및 데이터 조작이 가능하므로 서버 사이드에서 권한
검증 로직을 구현해야 함
참고 ※ 소스코드 및 취약점 점검 필요
점검 대상 및 판단 기준
대상 웹 애플리케이션 소스코드
...
![PDF 페이지 733의 원문 점검항목 영역](../assets/in/in-page-733-source-region.png)
...
![PDF 페이지 734의 원문 점검항목 영역](../assets/in/in-page-734-source-region.png)
