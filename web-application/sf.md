...
보안 위협 수집, 중요 정보(개인정보, 금융 정보, 인사 정보 등) 탈취, 임의 명령 실행, 클라우드 환경 내 메타데이터
수집을 통한 네트워크 인프라 장악이 가능함
참고 ※ 소스코드 및 취약점 점검 필요
점검 대상 및 판단 기준
대상 웹 애플리케이션 소스코드, 웹 애플리케이션 서버, 웹 방화벽, API 서버
양호 : 외부 입력값이 화이트리스트 방식으로 검증되어, 허용된 URL 또는 IP 범위 내에서만 처리될 경우
판단 기준 취약 : 외부 입력값이 검증이 이루어지지 않고 처리되어 허용되지 않는 자원에 임의적인 접근 및 요청이
가능한 경우
...
![PDF 페이지 719의 원문 점검항목 영역](../assets/sf/sf-page-719-source-region.png)
...
![PDF 페이지 720의 원문 점검항목 영역](../assets/sf/sf-page-720-source-region.png)
...
![PDF 페이지 721의 원문 점검항목 영역](../assets/sf/sf-page-721-source-region.png)
...
![PDF 페이지 722의 원문 점검항목 영역](../assets/sf/sf-page-722-source-region.png)
...
![PDF 페이지 723의 원문 점검항목 영역](../assets/sf/sf-page-723-source-region.png)
...
![PDF 페이지 724의 원문 점검항목 영역](../assets/sf/sf-page-724-source-region.png)
...
![PDF 페이지 725의 원문 점검항목 영역](../assets/sf/sf-page-725-source-region.png)
