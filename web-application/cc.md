...
classification:
  ...
  categoryIdentifier: web-application-cookie-tampering
...
참고 조각들을 저장 후, 동일한 서버에 대하여 재요청 시 저장된 데이터를 함께 전송
※ 소스코드 및 취약점 점검 필요
점검 대상 및 판단 기준
대상 웹 애플리케이션 소스코드
...
![PDF 페이지 769의 원문 점검항목 영역](../assets/cc/cc-page-769-source-region.png)
...
![PDF 페이지 770의 원문 점검항목 영역](../assets/cc/cc-page-770-source-region.png)
...
![PDF 페이지 771의 원문 점검항목 영역](../assets/cc/cc-page-771-source-region.png)
...
![PDF 페이지 772의 원문 점검항목 영역](../assets/cc/cc-page-772-source-region.png)
...
![PDF 페이지 773의 원문 점검항목 영역](../assets/cc/cc-page-773-source-region.png)
...
![PDF 페이지 774의 원문 점검항목 영역](../assets/cc/cc-page-774-source-region.png)
