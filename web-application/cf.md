...
보안 위협 요청을 전송할 수 있음. 이로 인해 사용자의 의도와 무관하게 비밀번호 변경, 계좌 이체, 게시글 삭제,
...
조치 방법 Referer/Origin 헤더 검증 및 SameSite 쿠키 옵션을 활용하여 불필요한 외부 도메인 요청이
차단되도록 구성
...
![PDF 페이지 715의 원문 점검항목 영역](../assets/cf/cf-page-715-source-region.png)
...
![PDF 페이지 716의 원문 점검항목 영역](../assets/cf/cf-page-716-source-region.png)
...
![PDF 페이지 717의 원문 점검항목 영역](../assets/cf/cf-page-717-source-region.png)
...
![PDF 페이지 718의 원문 점검항목 영역](../assets/cf/cf-page-718-source-region.png)
