...
보안 위협 해당 메소드들이 악용될 경우, 조작된 Server Side Script 파일 업로드, 민감 데이터 삭제, 서버 정보
노출 등이 가능함
※ Server Side Script: 웹에서 사용되는 스크립트 언어 중 서버 측에서 실행되는 스크립트
참고 ※ XST(Cross-Site Tracing): TRACE 메소드를 악용하여 httpOnly 등으로 보호된 세션 및 쿠키를
탈취할 수 있는 공격 기법
점검 대상 및 판단 기준
대상 웹 애플리케이션 서버
...
![PDF 페이지 779의 원문 점검항목 영역](../assets/wm/wm-page-779-source-region.png)
...
![PDF 페이지 780의 원문 점검항목 영역](../assets/wm/wm-page-780-source-region.png)
...
![PDF 페이지 781의 원문 점검항목 영역](../assets/wm/wm-page-781-source-region.png)
...
![PDF 페이지 782의 원문 점검항목 영역](../assets/wm/wm-page-782-source-region.png)
...
![PDF 페이지 783의 원문 점검항목 영역](../assets/wm/wm-page-783-source-region.png)
...
![PDF 페이지 784의 원문 점검항목 영역](../assets/wm/wm-page-784-source-region.png)
...
![PDF 페이지 785의 원문 점검항목 영역](../assets/wm/wm-page-785-source-region.png)
...
![PDF 페이지 786의 원문 점검항목 영역](../assets/wm/wm-page-786-source-region.png)
