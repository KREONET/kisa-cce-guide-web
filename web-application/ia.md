...
classification:
  ...
  categoryIdentifier: web-application-insufficient-authentication
...
보안 위협 접근으로 인해 중요 정보가 유출되거나 변조될 가능성이 있으므로, 해당 구간에는 추가적인 인증 절차를
서버 사이드 방식으로 구현 및 검증
참고 ※ 소스코드 및 취약점 점검 필요
점검 대상 및 판단 기준
대상 웹 애플리케이션 소스코드
...
![PDF 페이지 729의 원문 점검항목 영역](../assets/ia/ia-page-729-source-region.png)
...
![PDF 페이지 730의 원문 점검항목 영역](../assets/ia/ia-page-730-source-region.png)
...
![PDF 페이지 731의 원문 점검항목 영역](../assets/ia/ia-page-731-source-region.png)
...
![PDF 페이지 732의 원문 점검항목 영역](../assets/ia/ia-page-732-source-region.png)
