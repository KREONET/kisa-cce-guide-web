...
classification:
  ...
  categoryIdentifier: web-application-information-disclosure
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 708
      physicalPageEnd: 710
      printedPageStart: '708'
      printedPageEnd: '710'
sourceAnnotations: []
---
...
점검 목적 불필요한 정보(주석 내 디버깅 정보, 초기 샘플 페이지, 백업 파일 등)를 삭제하여 민감한 정보와 내부
시스템 정보의 노출을 차단하기 위함
...
![PDF 페이지 708의 원문 점검항목 영역](../assets/il/il-page-708-source-region.png)
...
![PDF 페이지 709의 원문 점검항목 영역](../assets/il/il-page-709-source-region.png)
...
![PDF 페이지 710의 원문 점검항목 영역](../assets/il/il-page-710-source-region.png)
