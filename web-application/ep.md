...
판단 기준 취약 : 에러 발생 시 기본 에러 페이지가 출력되며, 해당 페이지에 불필요한 정보(서버 버전 정보, 시스템
...
![PDF 페이지 703의 원문 점검항목 영역](../assets/ep/ep-page-703-source-region.png)
...
![PDF 페이지 704의 원문 점검항목 영역](../assets/ep/ep-page-704-source-region.png)
...
![PDF 페이지 705의 원문 점검항목 영역](../assets/ep/ep-page-705-source-region.png)
...
![PDF 페이지 706의 원문 점검항목 영역](../assets/ep/ep-page-706-source-region.png)
...
![PDF 페이지 707의 원문 점검항목 영역](../assets/ep/ep-page-707-source-region.png)
