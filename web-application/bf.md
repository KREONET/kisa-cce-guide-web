...
점검 내용 점검하고, 비밀번호 복잡성 요구사항(최소 길이, 대문자 및 소문자, 숫자 및 특수문자 포함 등)을 준수
여부 점검
...
![PDF 페이지 726의 원문 점검항목 영역](../assets/bf/bf-page-726-source-region.png)
...
![PDF 페이지 727의 원문 점검항목 영역](../assets/bf/bf-page-727-source-region.png)
...
![PDF 페이지 728의 원문 점검항목 영역](../assets/bf/bf-page-728-source-region.png)
