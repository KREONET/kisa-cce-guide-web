...
보안 위협 허용하며, 공격자는 민감 데이터의 조회, 수정, 삭제를 포함한 다양한 악의적인 행위가 가능하므로
...
조치 방법 검증 로직을 구현하여 서버에 검증되지 않는 SQL 쿼리요청 시 에러 페이지가 아닌 정상 페이지가
...
![PDF 페이지 693의 원문 점검항목 영역](../assets/si/si-page-693-source-region.png)
...
![PDF 페이지 694의 원문 점검항목 영역](../assets/si/si-page-694-source-region.png)
...
![PDF 페이지 695의 원문 점검항목 영역](../assets/si/si-page-695-source-region.png)
...
![PDF 페이지 696의 원문 점검항목 영역](../assets/si/si-page-696-source-region.png)
...
![PDF 페이지 697의 원문 점검항목 영역](../assets/si/si-page-697-source-region.png)
...
![PDF 페이지 698의 원문 점검항목 영역](../assets/si/si-page-698-source-region.png)
...
![PDF 페이지 699의 원문 점검항목 영역](../assets/si/si-page-699-source-region.png)
