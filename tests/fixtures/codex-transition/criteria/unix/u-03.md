...
보안 위협 추측 공격 등)의 인증 요청에 대해 설정된 비밀번호가 일치할 때까지 지속적으로 응답하여 해당 계정의
비밀번호가 유출될 위험이 존재함
...
조치 시 영향 경로에 존재하는지 확인 필요 (존재하지 않는 파일의 경로로 설정하는 경우 시스템 로그인에 장애가
발생할 수 있음)
...
![PDF 페이지 21의 원문 점검항목 영역](../../assets/u-03/u-03-page-21-source-region.png)
...
![PDF 페이지 22의 원문 점검항목 영역](../../assets/u-03/u-03-page-22-source-region.png)
...
![PDF 페이지 23의 원문 점검항목 영역](../../assets/u-03/u-03-page-23-source-region.png)
...
![PDF 페이지 24의 원문 점검항목 영역](../../assets/u-03/u-03-page-24-source-region.png)
