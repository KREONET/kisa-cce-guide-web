...
~~~text transcription
개요
점검 내용 DBMS 기본 계정의 초기 비밀번호 및 권한 정책을 변경하여 사용하는지 점검
...
보안 위협 기본 계정의 초기 비밀번호를 획득하여 초기 비밀번호를 그대로 사용하고 있는 DB에 접근하여 기본
계정에 부여된 권한의 취약점을 이용하여 DB 정보를 유출할 수 있는 위험이 존재함
참고 ※ 기본 계정: DB 설치 후 초기에 기본으로 생성되어있는 DBMS 관리용 계정(예 : sa)
점검 대상 및 판단 기준
...
조치 방법 기본(관리자) 계정의 초기 비밀번호 및 권한 정책 변경
조치 시 영향 불필요한 기본 계정의 사용 제한
점검 및 조치 사례
l Oracle DB
[기본 계정 비밀번호 변경]
...
![PDF 페이지 596의 원문 점검항목 영역](../assets/d-01/d-01-page-596-source-region.png)
...
![PDF 페이지 597의 원문 점검항목 영역](../assets/d-01/d-01-page-597-source-region.png)
...
![PDF 페이지 598의 원문 점검항목 영역](../assets/d-01/d-01-page-598-source-region.png)
...
![PDF 페이지 599의 원문 점검항목 영역](../assets/d-01/d-01-page-599-source-region.png)
