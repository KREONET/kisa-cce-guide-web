...
~~~text transcription
개요
점검 내용 xp_cmdshell의 사용 여부 점검
불필요하게 활성화되어 있는 xp_cmdshell를 제한하여 공격자의 무단 접근 및 악성코드의 실행 위험을
점검 목적
감소시키기 위함
보안 위협 해킹 툴에서 자주 이용되고 있으며, 권한 상승이나 데이터 유출 등의 위험이 존재함
참고 -
점검 대상 및 판단 기준
대상 MSSQL
...
조치 방법 xp_cmdshell 설정 값을 0 또는 False로 설정
조치 시 영향 xp_cmdshell을 사용하여 운영체제 명령을 실행하던 서비스 및 스크립트가 동작하지 않을 수 있음
점검 및 조치 사례
l MSSQL
...
![PDF 페이지 657의 원문 점검항목 영역](../assets/d-23/d-23-page-657-source-region.png)
...
![PDF 페이지 658의 원문 점검항목 영역](../assets/d-23/d-23-page-658-source-region.png)
...
![PDF 페이지 659의 원문 점검항목 영역](../assets/d-23/d-23-page-659-source-region.png)
...
![PDF 페이지 660의 원문 점검항목 영역](../assets/d-23/d-23-page-660-source-region.png)
