...
~~~text transcription
개요
점검 내용 시스템 테이블에 일반 사용자 계정이 접근할 수 없도록 설정되어 있는지 점검
...
조치 방법 시스템 테이블에 일반 사용자 계정이 접근할 수 없도록 설정
...
![PDF 페이지 633의 원문 점검항목 영역](../assets/d-11/d-11-page-633-source-region.png)
...
![PDF 페이지 634의 원문 점검항목 영역](../assets/d-11/d-11-page-634-source-region.png)
