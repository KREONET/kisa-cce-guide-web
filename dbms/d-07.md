...
~~~text transcription
개요
점검 내용 서비스 구동 시 root 계정 또는 root 권한으로 구동되는지 점검
...
![PDF 페이지 619의 원문 점검항목 영역](../assets/d-07/d-07-page-619-source-region.png)
...
![PDF 페이지 620의 원문 점검항목 영역](../assets/d-07/d-07-page-620-source-region.png)
