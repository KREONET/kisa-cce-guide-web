...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 616
      physicalPageEnd: 618
      printedPageStart: '616'
      printedPageEnd: '618'
sourceAnnotations: []
---
...
~~~text transcription
개요
점검 내용 DB 접근 시 사용자별로 서로 다른 계정을 사용하여 접근하는지 점검
...
![PDF 페이지 616의 원문 점검항목 영역](../assets/d-06/d-06-page-616-source-region.png)
...
![PDF 페이지 617의 원문 점검항목 영역](../assets/d-06/d-06-page-617-source-region.png)
...
![PDF 페이지 618의 원문 점검항목 영역](../assets/d-06/d-06-page-618-source-region.png)
