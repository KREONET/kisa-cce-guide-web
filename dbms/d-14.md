...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 639
      physicalPageEnd: 641
      printedPageStart: '639'
      printedPageEnd: '641'
sourceAnnotations: []
---
...
조치 방법 주요 설정 파일 및 디렉터리의 권한 설정 변경
...
![PDF 페이지 639의 원문 점검항목 영역](../assets/d-14/d-14-page-639-source-region.png)
...
![PDF 페이지 640의 원문 점검항목 영역](../assets/d-14/d-14-page-640-source-region.png)
...
![PDF 페이지 641의 원문 점검항목 영역](../assets/d-14/d-14-page-641-source-region.png)
