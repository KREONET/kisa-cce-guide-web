...
~~~text transcription
개요
점검 내용 응용 프로그램 또는 DBA 계정의 Role이 Public으로 설정되어 있는지 점검
...
![PDF 페이지 648의 원문 점검항목 영역](../assets/d-18/d-18-page-648-source-region.png)
...
![PDF 페이지 649의 원문 점검항목 영역](../assets/d-18/d-18-page-649-source-region.png)
