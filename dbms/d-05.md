...
~~~text transcription
개요
점검 내용 비밀번호 변경 시 이전 비밀번호를 재사용할 수 없도록 비밀번호 제약 설정이 되어있는지 점검
...
보안 위협 재사용함으로써 비인가자의 계정 비밀번호 추측 공격에 대한 시간을 더 많이 허용하여 비밀번호 유출
위험이 증가함
※ 비밀번호 제약 설정: 비밀번호 변경 시 이전에 사용했던 비밀번호를 재사용할 수 없게 하는
참고 설정으로써 이전 암호 재사용 가능 기간(PASSWORD_REUSE_TIME), 이전 암호 재사용 가능
...
조치 방법 PASSWORD_REUSE_TIME, PASSWORD_REUSE_MAX 파라미터 설정
...
![PDF 페이지 613의 원문 점검항목 영역](../assets/d-05/d-05-page-613-source-region.png)
...
![PDF 페이지 614의 원문 점검항목 영역](../assets/d-05/d-05-page-614-source-region.png)
...
![PDF 페이지 615의 원문 점검항목 영역](../assets/d-05/d-05-page-615-source-region.png)
