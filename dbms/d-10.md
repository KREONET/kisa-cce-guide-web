...
~~~text transcription
개요
점검 내용 지정된 IP주소만 DB 서버에 접근 가능하도록 설정되어 있는지 점검
...
조치 방법 DB 서버에 대해 지정된 IP주소에서만 접근 가능하도록 설정
...
![PDF 페이지 628의 원문 점검항목 영역](../assets/d-10/d-10-page-628-source-region.png)
...
추가 > IP주소 입력
[ 원격 데스크톱 – 사용자 모드(TCP-In) 속성 ] [ 원격 데스크톱 – 사용자 모드(UDP-In) 속성 ]
l Oracle DB
...
![PDF 페이지 629의 원문 점검항목 영역](../assets/d-10/d-10-page-629-source-region.png)
...
![PDF 페이지 630의 원문 점검항목 영역](../assets/d-10/d-10-page-630-source-region.png)
...
![PDF 페이지 631의 원문 점검항목 영역](../assets/d-10/d-10-page-631-source-region.png)
...
![PDF 페이지 632의 원문 점검항목 영역](../assets/d-10/d-10-page-632-source-region.png)
