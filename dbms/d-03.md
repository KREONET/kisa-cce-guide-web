...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 603
      ...
      printedPageEnd: '607'
sourceAnnotations:
  - annotationIdentifier: d-03-inventory-001
    ...
    sourceText: 비밀번호 사용 기간 및 복잡도를 기관의 정책에 맞도록 설정
    explanation: '{"anomalyType": "detailHeaderTitleMismatch", "code": "D-03", "detailHeaderTitle": "비밀번호 사용 기간 및 복잡도를 기관의 정책에 맞도록 설정", "physicalPage": 603, "resolution": "Use the detailed criterion heading as the canonical title and preserve the chapter summary value as an annotation.", "summaryTitle": "비밀번호의 사용기간 및 복잡도를 기관의 정책에 맞도록 설정"}'
...
~~~text transcription
개요
점검 내용 기관 정책에 맞게 비밀번호 사용 기간 및 복잡도 설정이 적용되어 있는지 점검
...
조치 방법 기관 정책에 맞게 비밀번호 사용 기간 및 복잡도 정책 설정
조치 시 영향 주기적인 비밀번호 변경 필요
점검 및 조치 사례
l Oracle DB
...
![PDF 페이지 603의 원문 점검항목 영역](../assets/d-03/d-03-page-603-source-region.png)
...
![PDF 페이지 604의 원문 점검항목 영역](../assets/d-03/d-03-page-604-source-region.png)
...
![PDF 페이지 605의 원문 점검항목 영역](../assets/d-03/d-03-page-605-source-region.png)
...
![PDF 페이지 606의 원문 점검항목 영역](../assets/d-03/d-03-page-606-source-region.png)
...
![PDF 페이지 607의 원문 점검항목 영역](../assets/d-03/d-03-page-607-source-region.png)
