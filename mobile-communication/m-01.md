...
criterion:
  code: M-01
  slug: m-01
  title: 이동통신망 엣지 네트워크 운영 시 인터넷 연결 등을 고려한 보안기술을 적용
  severity:
    level: high
    sourceLabel: 상
classification:
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 672
      physicalPageEnd: 672
      printedPageStart: '672'
      printedPageEnd: '672'
sourceAnnotations: []
---
...
점검 목적 사용자의 트래픽 네트워크와 엣지 네트워크를 관리하는 네트워크를 최대한 안전한 보안기술을 사용하여
안전하게 분리하여 운영하기 위함
...
![PDF 페이지 672의 원문 점검항목 영역](../assets/m-01/m-01-page-672-source-region.png)
