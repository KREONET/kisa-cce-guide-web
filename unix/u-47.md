...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 113
      physicalPageEnd: 115
      printedPageStart: '113'
      printedPageEnd: '115'
sourceAnnotations: []
---
...
점검 목적 스팸 메일 서버로의 악용 방지 및 서버 과부하를 방지하기 위함
...
![PDF 페이지 113의 원문 점검항목 영역](../assets/u-47/u-47-page-113-source-region.png)
...
![PDF 페이지 114의 원문 점검항목 영역](../assets/u-47/u-47-page-114-source-region.png)
...
![PDF 페이지 115의 원문 점검항목 영역](../assets/u-47/u-47-page-115-source-region.png)
