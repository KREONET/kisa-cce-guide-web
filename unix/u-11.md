...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 35
      physicalPageEnd: 35
      printedPageStart: '35'
      printedPageEnd: '35'
sourceAnnotations:
  - annotationIdentifier: u-11-inventory-001
    ...
    sourceLocation:
      physicalPage: 35
      printedPage: '35'
      pageRegionIdentifier: p35-u-11
    sourceText: 사용자 shell 점검
    explanation: '{"anomalyType": "detailHeaderTitleMismatch", "code": "U-11", "detailHeaderTitle": "사용자 shell 점검", "physicalPage": 35, "resolution": "Use the detailed criterion heading as the canonical title and preserve the chapter summary value as an annotation.", "summaryTitle": "사용자 Shell 점검"}'
...
점검 목적
실행하지 못하게 하기 위함
보안 위협 로그인이 불필요한 계정에 쉘이 부여될 경우, 비인가자가 해당 기본 계정으로 시스템에 접근 위험이 존재함
...
조치 방법 로그인이 필요하지 않은 계정에 대해 /bin/false(/sbin/nologin) 쉘 부여 설정
...
![PDF 페이지 35의 원문 점검항목 영역](../assets/u-11/u-11-page-35-source-region.png)
