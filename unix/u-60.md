...
시스템을 말함
참고 ※ Community String: SNMP는 MIB라는 정보를 주고받기 위해 인증 과정에서 일종의 비밀번호인
...
판단 기준 취약 : 아래의 내용 중 하나라도 해당되는 경우
...
조치 방법 Ÿ SNMP 서비스 사용 시 SNMP Community String 기본값인 “public”, “private”이 아닌 영문자,
...
![PDF 페이지 145의 원문 점검항목 영역](../assets/u-60/u-60-page-145-source-region.png)
...
![PDF 페이지 146의 원문 점검항목 영역](../assets/u-60/u-60-page-146-source-region.png)
...
![PDF 페이지 147의 원문 점검항목 영역](../assets/u-60/u-60-page-147-source-region.png)
