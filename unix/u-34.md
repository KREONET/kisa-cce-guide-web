...
참고 보여주는 데 반해 Finger 명령은 옵션에 따른 시스템에 등록된 사용자뿐만 아니라 네트워크를
...
![PDF 페이지 68의 원문 점검항목 영역](../assets/u-34/u-34-page-68-source-region.png)
...
![PDF 페이지 69의 원문 점검항목 영역](../assets/u-34/u-34-page-69-source-region.png)
