...
sourceAnnotations:
  - annotationIdentifier: u-38-source-001
    annotationType: sourceInconsistency
    targetType: astNode
    targetReference: "u-38:remediation.linux.step:2"
    sourceLocation:
      physicalPage: 83
      printedPage: "83"
      pageRegionIdentifier: p83-u-38
    sourceText: "주석 제거"
    explanation: "서비스 비활성화라는 조치 목적 및 AIX, HP-UX 절차의 주석 처리 지시와 달리, Linux inetd 절차는 주석 제거를 지시한다."
    disposition: unresolved
    reviewStatus: pending
    verificationEvidence:
      - "PDF physical page 83의 Linux inetd Step 2와 physical page 84의 AIX, HP-UX Step 2를 대조했다."
    reviewedBy: null
    reviewedAt: null
    approvedBy: null
    approvedAt: null
