...
~~~text transcription
개요
점검 내용 내부 정책에 따른 시스템 로깅 설정 여부 점검
...
참고 수 있으며 시스템 성능에도 심각한 영향을 줄 수 있으므로 법적 요구 사항과 조직의 정책에 따라
필요한 로그를 남기도록 설정해야 함
점검 대상 및 판단 기준
...
조치 방법 로그 기록 정책을 수립하고, 정책에 따라 (r)syslog.conf 파일을 설정
...
![PDF 페이지 166의 원문 점검항목 영역](../assets/u-66/u-66-page-166-source-region.png)
...
![PDF 페이지 167의 원문 점검항목 영역](../assets/u-66/u-66-page-167-source-region.png)
...
![PDF 페이지 168의 원문 점검항목 영역](../assets/u-66/u-66-page-168-source-region.png)
...
![PDF 페이지 169의 원문 점검항목 영역](../assets/u-66/u-66-page-169-source-region.png)
...
![PDF 페이지 170의 원문 점검항목 영역](../assets/u-66/u-66-page-170-source-region.png)
