...
참고 v2, v3 세 가지 버전이 존재하는데 v1, v2는 요청 및 응답 패킷이 평문으로 전송되기 때문에
...
![PDF 페이지 143의 원문 점검항목 영역](../assets/u-59/u-59-page-143-source-region.png)
...
![PDF 페이지 144의 원문 점검항목 영역](../assets/u-59/u-59-page-144-source-region.png)
