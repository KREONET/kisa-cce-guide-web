...
위험이 존재함
보안 위협 Ÿ 접근을 허용한 웹 디렉터리 내에 서버의 다른 디렉터리나 파일들에 접근할 수 있는 심볼릭 링크,
...
![PDF 페이지 305의 원문 점검항목 영역](../assets/web-12/web-12-page-305-source-region.png)
...
![PDF 페이지 306의 원문 점검항목 영역](../assets/web-12/web-12-page-306-source-region.png)
...
![PDF 페이지 307의 원문 점검항목 영역](../assets/web-12/web-12-page-307-source-region.png)
