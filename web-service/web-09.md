...
점검 목적 서비스의 취약점을 이용해 시스템에 대한 어떤 권한도 획득할 수 없도록 하여 침해사고 발생 시 피해
범위 확산을 방지하기 위함
웹 프로세스 권한을 제한하지 않은 경우, 웹 사이트 방문자가 웹 서비스의 취약점을 이용하여 시스템
보안 위협 권한을 획득할 수 있으며, 웹 취약점을 통해 접속 권한을 획득한 경우에는 관리자 권한을 획득하여
...
![PDF 페이지 295의 원문 점검항목 영역](../assets/web-09/web-09-page-295-source-region.png)
...
![PDF 페이지 296의 원문 점검항목 영역](../assets/web-09/web-09-page-296-source-region.png)
...
![PDF 페이지 297의 원문 점검항목 영역](../assets/web-09/web-09-page-297-source-region.png)
...
![PDF 페이지 298의 원문 점검항목 영역](../assets/web-09/web-09-page-298-source-region.png)
...
![PDF 페이지 299의 원문 점검항목 영역](../assets/web-09/web-09-page-299-source-region.png)
