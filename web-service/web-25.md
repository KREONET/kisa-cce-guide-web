...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 347
      physicalPageEnd: 349
      printedPageStart: '347'
      printedPageEnd: '349'
sourceAnnotations: []
---
...
판단 기준 취약 : 최신 보안 패치가 적용되어 있지 않거나 패치 적용 정책을 수립 및 주기적인 패치 관리를 하지
않는 경우
...
![PDF 페이지 347의 원문 점검항목 영역](../assets/web-25/web-25-page-347-source-region.png)
...
![PDF 페이지 348의 원문 점검항목 영역](../assets/web-25/web-25-page-348-source-region.png)
...
![PDF 페이지 349의 원문 점검항목 영역](../assets/web-25/web-25-page-349-source-region.png)
