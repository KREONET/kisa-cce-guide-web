...
보안 위협 악의적인 파일을 업로드하고 이를 실행하여 시스템의 중요 정보가 노출될 수 있으며 침해사고의 경로로
이용될 위험이 존재함
※ CGI(Common Gateway Interface): 사용자가 서버로 보낸 데이터를 서버에서 작동 중인 데이터
참고 처리프로그램에 전달하고, 여기에서 처리된 데이터를 다시 서버로 되돌려 보내는 등의 일을 하는
표준 인터페이스 규격
점검 대상 및 판단 기준
...
![PDF 페이지 283의 원문 점검항목 영역](../assets/web-05/web-05-page-283-source-region.png)
...
![PDF 페이지 284의 원문 점검항목 영역](../assets/web-05/web-05-page-284-source-region.png)
...
![PDF 페이지 285의 원문 점검항목 영역](../assets/web-05/web-05-page-285-source-region.png)
