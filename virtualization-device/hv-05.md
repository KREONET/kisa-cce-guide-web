...
점검 목적 시스템 침입 경로 유출 위험을 줄이고 관리자 계정이 아닌 일반 계정이 공격자에게 탈취되었을 때 가상화
...
![PDF 페이지 800의 원문 점검항목 영역](../assets/hv-05/hv-05-page-800-source-region.png)
...
![PDF 페이지 801의 원문 점검항목 영역](../assets/hv-05/hv-05-page-801-source-region.png)
...
![PDF 페이지 802의 원문 점검항목 영역](../assets/hv-05/hv-05-page-802-source-region.png)
...
![PDF 페이지 803의 원문 점검항목 영역](../assets/hv-05/hv-05-page-803-source-region.png)
