...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 850
      physicalPageEnd: 850
      printedPageStart: "850"
      printedPageEnd: "850"

sourceAnnotations:
  - annotationIdentifier: hv-25-source-001
    annotationType: sourceInconsistency
    targetType: astNode
    targetReference: "hv-25:remediation.supplementaryGuidance.table:1"
    sourceLocation:
      physicalPage: 850
      printedPage: "850"
      pageRegionIdentifier: p850-hv-25
    sourceText: "https:/support.broadcom.com/web/ecx/security-advisory"
    explanation: "URL의 https: 뒤에 슬래시가 하나만 표기되어 있다."
    disposition: unresolved
    reviewStatus: pending
    verificationEvidence:
      - "PDF physical page 850의 VMware ESXi, vCenter 행을 확인했다."
    reviewedBy: null
    reviewedAt: null
    approvedBy: null
    approvedAt: null
