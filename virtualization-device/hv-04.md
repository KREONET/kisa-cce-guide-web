...
보안 위협 계정 및 퇴사자 계정이 존재할 경우 해당 계정을 통한 침해사고 발생 시 사후 추적이 어려울 수 있는
위험이 존재함
...
![PDF 페이지 798의 원문 점검항목 영역](../assets/hv-04/hv-04-page-798-source-region.png)
...
![PDF 페이지 799의 원문 점검항목 영역](../assets/hv-04/hv-04-page-799-source-region.png)
