...
sourceAnnotations:
  - annotationIdentifier: u-11-source-001
    annotationType: sourceInconsistency
    targetType: astNode
    targetReference: "u-11:remediation.solaris.table:1"
    sourceLocation:
      physicalPage: 35
      printedPage: "35"
      pageRegionIdentifier: p35-u-11
    sourceText: "deamon"
    explanation: "계정 목록에는 deamon으로 표기되어 있으나, 같은 페이지의 점검 명령과 점검 내용에는 daemon으로 표기되어 있다."
    disposition: unresolved
    reviewStatus: pending
    verificationEvidence:
      - "PDF physical page 35의 계정 목록, 점검 명령, 점검 내용을 대조했다."
    reviewedBy: null
    reviewedAt: null
    approvedBy: null
    approvedAt: null
...
> **참고**
>
> **`/bin/false`:** 시스템 접근을 항상 실패로 처리해 로그인을 차단하고, 사용자에게 메시지를 출력하지 않으며, 서비스 계정의 직접 접근 차단에 사용됨

> **참고**
>
> **`/sbin/nologin`:** 로그인 시 “This account is currently not available” 메시지를 출력하며 접근을 차단하고, FTP와 같은 일부 서비스의 접근은 허용됨
