...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 205
      physicalPageEnd: 206
      printedPageStart: "205"
      printedPageEnd: "206"
...
> **참고**
>
> **NetBIOS(Network Basic Input/Output System)**는 별개의 컴퓨터상에 있는 응용프로그램들이 근거리통신망 내에서 서로 통신할 수 있게 해주는 API. 이름 서비스, 세션 서비스, 데이터그램 서비스를 제공하며, 주로 네트워크 장치 간의 통신을 지원
...
1. 시작 > 제어판 > 네트워크 및 공유 센터 > 어댑터 설정 변경 > 로컬 영역 연결 > 속성 > TCP/IP > [일반] 탭에서 [고급] 클릭
2. [WINS] 탭에서 TCP/IP에서 “NetBIOS 사용 안 함” 또는, “NetBIOS over TCP/IP 사용 안 함” 선택
