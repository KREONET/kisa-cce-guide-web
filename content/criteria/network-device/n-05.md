...
sourceAnnotations:
  - annotationIdentifier: n-05-source-001
    annotationType: sourceTypographicalError
    targetType: astNode
    targetReference: "n-05:remediation.linux.configuration:1"
    sourceLocation:
      physicalPage: 404
      printedPage: "404"
      pageRegionIdentifier: p404-n-05
    sourceText: "login {10"
    explanation: "구성 예시에 숫자 10이 중괄호 바로 뒤에 표기되어 있으며 의미가 불명확하다. 원문 표기를 유지했다."
    disposition: unresolved
    reviewStatus: pending
    verificationEvidence:
      - "PDF physical page 404의 Juniper Junos Step 3 구성 예시를 확인했다."
    reviewedBy: null
    reviewedAt: null
    approvedBy: null
    approvedAt: null
...
2. `[edit system login]` hierarchy level 확인

3. `[edit system]`에서 다음과 같이 설정
