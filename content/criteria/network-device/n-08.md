...
sourceAnnotations:
  - annotationIdentifier: n-08-source-001
    annotationType: sourceDuplication
    targetType: astNode
    targetReference: "n-08:remediation.unspecified.configuration:7"
    sourceLocation:
      physicalPage: 414
      printedPage: "414"
      pageRegionIdentifier: p414-n-08
    sourceText: "(config-management-access)# ssh status enable"
    explanation: "Piolink PLOS의 Step 1과 Step 2에 같은 SSH 활성화 명령이 반복된다."
    disposition: unresolved
    reviewStatus: pending
    verificationEvidence:
      - "PDF physical page 414의 Piolink PLOS Step 1과 Step 2를 대조했다."
    reviewedBy: null
    reviewedAt: null
    approvedBy: null
    approvedAt: null
...
> **참고**
>
> **스니핑(임의 지정) 공격:** 스니퍼(Sniffer)는 “컴퓨터 네트워크상에 흘러 다니는 트래픽을 엿듣는 도청장치”라고 말할 수 있으며 “스니핑”이란 이러한 스니퍼를 이용하여 네트워크상의 데이터를 도청하는 행위를 말함
