...
sourceAnnotations:
  - annotationIdentifier: n-10-source-001
    annotationType: sourceInconsistency
    targetType: astNode
    targetReference: "n-10:assessment.target.paragraph:1"
    sourceLocation:
      physicalPage: 417
      printedPage: "417"
      pageRegionIdentifier: p417-n-10
    sourceText: "Cisco, Alteon, Juniper 등"
    explanation: "원문의 네트워크 장비 제품군과 제공된 대상 분류가 일치하지 않아 Linux 분류의 적합성을 확인해야 한다."
    disposition: unresolved
    reviewStatus: pending
    verificationEvidence:
      - "PDF physical pages 417-418의 대상 행과 제품별 조치 사례를 대조했다."
    reviewedBy: null
    reviewedAt: null
    approvedBy: null
    approvedAt: null
