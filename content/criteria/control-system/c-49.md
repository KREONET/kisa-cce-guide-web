...
criterion:
  code: C-49
  slug: c-49
  title: 제어시스템 유지보수를 위한 전용 장비(노트북 등)를 마련하고 관련 정책을 시행
  severity:
    level: low
    sourceLabel: 하
...
provenance:
  ...
  sourcePageRanges:
    - physicalPageStart: 548
      physicalPageEnd: 548
      printedPageStart: "548"
      printedPageEnd: "548"
...
1. 제어시스템 구성요소의 유지보수를 위한 전용 장비를 확인하고 해당 장비가 없는 경우 유지보수 전용 장비를 마련하도록 조치
2. 제어시스템 유지보수 전용 장비의 안전한 관리 정책을 수립하여 시행하는지 확인하고 미흡한 경우 유지보수 전용 장비의 안전한 관리 정책을 수립하고 시행하도록 조치
