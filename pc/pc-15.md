...
참고 침입으로부터 내부의 정보 자산을 보호하고 외부로부터 유해 정보 유입을 차단하기 위한 정책과
...
조치 방법 Windows 방화벽 “사용”으로 설정 또는 유·무료 기타 방화벽을 사용
...
![PDF 페이지 585의 원문 점검항목 영역](../assets/pc-15/pc-15-page-585-source-region.png)
...
![PDF 페이지 586의 원문 점검항목 영역](../assets/pc-15/pc-15-page-586-source-region.png)
