...
~~~text transcription
개요
점검 내용 비밀번호 설정 정책이 복잡성을 만족하는지 점검
...
판단 기준 취약 : 비밀번호를 사용하지 않거나, 추측하기 쉬운 문자조합으로 이루어진 짧은 자릿수의 비밀번호를
설정된 경우
...
![PDF 페이지 557의 원문 점검항목 영역](../assets/pc-02/pc-02-page-557-source-region.png)
...
![PDF 페이지 558의 원문 점검항목 영역](../assets/pc-02/pc-02-page-558-source-region.png)
