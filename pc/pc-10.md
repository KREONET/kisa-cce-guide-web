...
~~~text transcription
개요
점검 내용 시스템에 관련한 공개된 취약점에 대한 최신 보안패치를 적용하였는지 점검
점검 목적 공개된 취약점을 통한 침해사고 발생을 방지하기 위함
...
조치 방법 Windows Update 사이트에 접속하여 최신 패치 존재 여부 확인 및 패치 적용
...
![PDF 페이지 577의 원문 점검항목 영역](../assets/pc-10/pc-10-page-577-source-region.png)
...
![PDF 페이지 578의 원문 점검항목 영역](../assets/pc-10/pc-10-page-578-source-region.png)
