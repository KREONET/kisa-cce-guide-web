...
~~~text transcription
개요
점검 내용 하드 디스크의 파일 시스템이 NTFS를 사용 여부 점검
...
보안 위협 파일을 읽을 수 있으므로, 중요 파일에 접근할 수 없는 비인가자가 주요 정보를 유출할 수 있는 위험이
존재함
...
참고 ※ ACL: 프로세스가 시스템이나 파일에 읽기, 쓰기, 실행 등의 접근 여부를 허가하거나 거부하는 기능
...
조치 방법 모든 디스크 볼륨에 대해 파일 시스템 NTFS로 변경
...
![PDF 페이지 571의 원문 점검항목 영역](../assets/pc-07/pc-07-page-571-source-region.png)
...
![PDF 페이지 572의 원문 점검항목 영역](../assets/pc-07/pc-07-page-572-source-region.png)
