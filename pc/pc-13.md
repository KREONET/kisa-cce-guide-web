...
~~~text transcription
개요
점검 내용 시스템에 백신이 설치되어 있고 백신이 주기적으로 자동 업데이트되는 설정 여부 점검
...
보안 위협 악성코드(바이러스, 웜, 랜섬웨어, 스파이웨어 등)의 감염이 발생하여 시스템의 중요한 파일이나 폴더의
...
다른 파일들까지 급속하게 감염시킴
참고 ※ 웜(Worm): 컴퓨터 바이러스의 하나로 컴퓨터 바이러스와 비슷하지만, 바이러스가 다른 실행
...
![PDF 페이지 582의 원문 점검항목 영역](../assets/pc-13/pc-13-page-582-source-region.png)
...
![PDF 페이지 583의 원문 점검항목 영역](../assets/pc-13/pc-13-page-583-source-region.png)
